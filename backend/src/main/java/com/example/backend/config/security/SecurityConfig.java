...
import com.example.backend.dto.SocialResponseDTO;
...
import static com.example.backend.common.Constants.LOGIN_AUTH_WHITELIST;
import static com.example.backend.common.Constants.SOCIAL_LOGIN_AUTH_WHITELIST;
import static com.example.backend.common.Constants.SWAGER_AUTH_WHITELIST;
...
//azure
    ...
    private void successHandler(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        var list = userDetails.getAuthorities().stream()
                .map(Object::toString)
